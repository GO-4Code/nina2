  ...
  return (
    ...
    <section className="text-gray-600 body-font pt-24 ">
        ...
        <img
          ...
          alt="Banner NewsX.press"
          src="./images/Banner-NewsXpress.webp"
        ></img>
      </div>
      <div className="max-w-5xl pt-22 pb-24 mx-auto">
        <h1 className="text-80 text-center lh-6 ld-04 font-bold text-white mb-6">
        The Future of News
        </h1>
        <h2 className="text-2xl  font-semibold lh-6 ld-04 text-gray-600 text-center">
        Experience the next generation of news delivery.
        </h2>
      

        <h2 className="text-2xl font-semibold pb-4 text-center flex justify-center gap-4">
  <span className="bg-clip-text text-transparent bg-gradient-to-b from-blue-800 to-blue-400">
    AI Curated.
  </span>
  <span className="bg-clip-text text-transparent bg-gradient-to-b from-purple-700 to-purple-400">
    Hyper Personalized.
  </span>
  <span className="bg-clip-text text-transparent bg-gradient-to-b from-red-700 to-pink-400">
   In Realtime.
  </span>
</h2>
        ...
        <img
         className="object-cover w-1/6 mb-20"
         alt="Badge OpenAI"
